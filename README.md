# Hi, I'm Seungwoo Son 👋 Satellite Image & Geospatial Data Processing
...
위성 영상(SAR/EO)과 GPS 기반 시공간 데이터를 다루며, 이종 센서 간 정합(matching)과 지표 변위 관측에 관심이 많은 데이터 처리 엔지니어입니다.
InSAR을 통한 지표 변위 분석 연구를 시작으로, 현재는 SAR-EO 이미지 매칭 연구를 진행하고 있으며, GPS 위성 기반 실시간 데이터를 활용한 시스템을 설계해 정부/공공기관 공모전에서 수상한 경험이 있습니다.
